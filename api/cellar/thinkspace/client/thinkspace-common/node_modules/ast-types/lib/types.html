<!DOCTYPE html><html lang="en"><head><title>thinkspace/client/thinkspace-common/node_modules/ast-types/lib/types</title></head><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0, minimum-scale=1.0, maximum-scale=1.0"><meta name="groc-relative-root" content="../../../../../../"><meta name="groc-document-path" content="thinkspace/client/thinkspace-common/node_modules/ast-types/lib/types"><meta name="groc-project-path" content="src/thinkspace/client/thinkspace-common/node_modules/ast-types/lib/types.js"><meta name="groc-branch-path" content="master"><meta name="groc-github-url" content="https://github.com/sixthedge/cellar"><link rel="stylesheet" type="text/css" media="all" href="../../../../../../assets/style.css"><script type="text/javascript" src="../../../../../../assets/behavior.js"></script><body><div id="meta"><div class="file-path"><a href="https://github.com/sixthedge/cellar/blob/master/src/thinkspace/client/thinkspace-common/node_modules/ast-types/lib/types.js">src/thinkspace/client/thinkspace-common/node_modules/ast-types/lib/types.js</a></div></div><div id="document"><a href="/" class="lodestar-link">Back to Guides</a><div class="segment"><div class="code"><div class="wrapper"><span class="hljs-keyword">var</span> Ap = <span class="hljs-built_in">Array</span>.prototype;
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
    ...
    <span class="hljs-keyword">var</span> exports = {};</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>A type is an object with a .check method that takes a value and returns
true or false according to whether the value matches the type.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Type</span>(<span class="hljs-params">check, name</span>) </span>{
        ...
        }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Unfortunately we can&#39;t elegantly reuse isFunction and isString,
here, because this code is executed while defining those types.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (objToStr.call(check) !== funObjStr) {
        ...
        }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>The <code>name</code> parameter can be either a function or a string.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">var</span> nameObjStr = objToStr.call(name);
        ...
        <span class="hljs-built_in">Object</span>.defineProperties(self, {
            name: {value: name},
            check: {
                value: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, deep</span>) </span>{
    ...
    <span class="hljs-keyword">var</span> Tp = Type.prototype;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Throughout this file we use Object.defineProperty to prevent
redefinition of exported properties.</p></div></div><div class="code"><div class="wrapper">    exports.Type = Type;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Like .check, except that failure triggers an AssertionError.</p></div></div><div class="code"><div class="wrapper">    Tp.assert = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, deep</span>) </span>{
    ...
    }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>These types check the underlying [[Class]] attribute of the given
value, rather than using the problematic typeof operator. Note however
that no subtyping is considered; so, for instance, isObject.check
returns false for [], /./, new Date, and null.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-keyword">var</span> isString = defBuiltInType(<span class="hljs-string">"truthy"</span>, <span class="hljs-string">"string"</span>);
    ...
    <span class="hljs-keyword">var</span> isUndefined = defBuiltInType(<span class="hljs-keyword">void</span> <span class="hljs-number">0</span>, <span class="hljs-string">"undefined"</span>);</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>There are a number of idiomatic ways of expressing types, so this
function serves to coerce them all to actual Type objects. Note that
providing the name argument is not necessary in most cases.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">toType</span>(<span class="hljs-params">from, name</span>) </span>{</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>The toType function should of course be idempotent.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (from <span class="hljs-keyword">instanceof</span> Type)
            <span class="hljs-keyword">return</span> from;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>The Def type is used as a helper for constructing compound
interface types for AST nodes.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (from <span class="hljs-keyword">instanceof</span> Def)
            <span class="hljs-keyword">return</span> from.type;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Support [ElemType] syntax.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (isArray.check(from))
            <span class="hljs-keyword">return</span> Type.fromArray(from);</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Support { someField: FieldType, ... } syntax.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (isObject.check(from))
            <span class="hljs-keyword">return</span> Type.fromObject(from);

        <span class="hljs-keyword">if</span> (isFunction.check(from)) {
            <span class="hljs-keyword">var</span> bicfIndex = builtInCtorFns.indexOf(from);
            ...
            }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>If isFunction.check(from), and from is not a built-in
constructor, assume from is a binary predicate function we can
use to define the type.</p></div></div><div class="code"><div class="wrapper">            <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> Type(from, name);
        }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>As a last resort, toType returns a type that matches any value that
is === from. This is primarily useful for literal values like
toType(null), but it has the additional advantage of allowing
toType to be a total function.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> Type(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value</span>) </span>{
            <span class="hljs-keyword">return</span> value === from;
        }, isUndefined.check(name) ? <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
            <span class="hljs-keyword">return</span> from + <span class="hljs-string">""</span>;
        } : name);
    }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Returns a type that matches the given value iff any of type1, type2,
etc. match the value.</p></div></div><div class="code"><div class="wrapper">    Type.or = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"><span class="hljs-comment">/* type1, type2, ... */</span></span>) </span>{
    ...
    Fp.getValue = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">obj</span>) </span>{
        ...
        <span class="hljs-keyword">return</span> value;
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Define a type whose name is registered in a namespace (the defCache) so
that future definitions will return the same type given the same name.
In particular, this system allows for circular and forward definitions.
The Def object d returned from Type.def may be used to configure the
type d.type by calling methods such as d.bases, d.build, and d.field.</p></div></div><div class="code"><div class="wrapper">    Type.def = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">typeName</span>) </span>{
    ...
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>In order to return the same Def instance every time Type.def is called
with a particular name, those instances need to be stored in a cache.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-keyword">var</span> defCache = <span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>);
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">Def</span>(<span class="hljs-params">typeName</span>) </span>{
        ...
        <span class="hljs-built_in">Object</span>.defineProperties(self, {
            ...
            baseNames: {value: []},
            ownFields: {value: <span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>)},</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>These two are populated during finalization.</p></div></div><div class="code"><div class="wrapper">            allSupertypes: {value: <span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>)}, <span class="hljs-comment">// Includes own typeName.</span>
            supertypeList: {value: []}, <span class="hljs-comment">// Linear inheritance hierarchy.</span>
            allFields: {value: <span class="hljs-built_in">Object</span>.create(<span class="hljs-literal">null</span>)}, <span class="hljs-comment">// Includes inherited fields.</span>
            fieldNames: {value: []}, <span class="hljs-comment">// Non-hidden keys of allFields.</span>

            type: {
                value: <span class="hljs-keyword">new</span> Type(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, deep</span>) </span>{
    ...
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Note that the list returned by this function is a copy of the internal
supertypeList, <em>without</em> the typeName itself as the first element.</p></div></div><div class="code"><div class="wrapper">    exports.getSupertypeNames = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">typeName</span>) </span>{
    ...
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Returns an object mapping from every known type in the defCache to the
most specific supertype whose name is an own property of the candidates
object.</p></div></div><div class="code"><div class="wrapper">    exports.computeSupertypeLookupTable = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">candidates</span>) </span>{
    ...
    Dp.check = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">value, deep</span>) </span>{
        ...
        }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>A Def type can only match an object value.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (!isObject.check(value))
            <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;

        <span class="hljs-keyword">var</span> vDef = Def.fromValue(value);
        <span class="hljs-keyword">if</span> (!vDef) {</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>If we couldn&#39;t infer the Def associated with the given value,
and we expected it to be a SourceLocation or a Position, it was
probably just missing a &quot;type&quot; field (because Esprima does not
assign a type property to such nodes). Be optimistic and let
this.checkAllFields make the final decision.</p></div></div><div class="code"><div class="wrapper">            <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.typeName === <span class="hljs-string">"SourceLocation"</span> ||
            ...
            }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Calling this.checkAllFields for any other type of node is both
bad for performance and way too forgiving.</p></div></div><div class="code"><div class="wrapper">            <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;
        }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>If checking deeply and vDef === this, then we only need to call
checkAllFields once. Calling checkAllFields is too strict when deep
is false, because then we only care about this.isSupertypeOf(vDef).</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (deep &amp;&amp; vDef === <span class="hljs-keyword">this</span>)
            <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.checkAllFields(value, deep);</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>In most cases we rely exclusively on isSupertypeOf to make O(1)
subtyping determinations. This suffices in most situations outside
of unit tests, since interface conformance is checked whenever new
instances are created using builder functions.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (!<span class="hljs-keyword">this</span>.isSupertypeOf(vDef))
            <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>The exception is when deep is true; then, we recursively check all
fields.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (!deep)
            <span class="hljs-keyword">return</span> <span class="hljs-literal">true</span>;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Use the more specific Def (vDef) to perform the deep check, but
shallow-check fields defined by the less specific Def (this).</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">return</span> vDef.checkAllFields(value, deep)
    ...
    Dp.bases = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        ...
        args.forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">baseName</span>) </span>{
            isString.assert(baseName);</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>This indexOf lookup may be O(n), but the typical number of base
names is very small, and indexOf is a native Array method.</p></div></div><div class="code"><div class="wrapper">            <span class="hljs-keyword">if</span> (bases.indexOf(baseName) &lt; <span class="hljs-number">0</span>)
                bases.push(baseName);
        });

        <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>; <span class="hljs-comment">// For chaining.</span>
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>False by default until .build(...) is called on an instance.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-built_in">Object</span>.defineProperty(Dp, <span class="hljs-string">"buildable"</span>, {value: <span class="hljs-literal">false</span>});

    <span class="hljs-keyword">var</span> builders = {};
    exports.builders = builders;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>This object is used as prototype for any node created by a builder.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-keyword">var</span> nodePrototype = {};</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Call this function to define a new method to be shared by all AST
nodes. The replaced method (if any) is returned for easy wrapping.</p></div></div><div class="code"><div class="wrapper">    exports.defineMethod = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">name, func</span>) </span>{
        <span class="hljs-keyword">var</span> old = nodePrototype[name];</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Pass undefined as func to delete nodePrototype[name].</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (isUndefined.check(func)) {
            ...
            <span class="hljs-built_in">Object</span>.defineProperty(nodePrototype, name, {
                enumerable: <span class="hljs-literal">true</span>, <span class="hljs-comment">// For discoverability.</span>
    ...
    <span class="hljs-keyword">var</span> isArrayOfString = isString.arrayOf();</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Calling the .build method of a Def simultaneously marks the type as
buildable (by defining builders[getBuilderName(typeName)]) and
specifies the order of arguments that should be passed to the builder
function to create an instance of the type.</p></div></div><div class="code"><div class="wrapper">    Dp.build = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"><span class="hljs-comment">/* param1, param2, ... */</span></span>) </span>{
        <span class="hljs-keyword">var</span> self = <span class="hljs-keyword">this</span>;

        <span class="hljs-keyword">var</span> newBuildParams = slice.call(<span class="hljs-built_in">arguments</span>);
        isArrayOfString.assert(newBuildParams);</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Calling Def.prototype.build multiple times has the effect of merely
redefining this property.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-built_in">Object</span>.defineProperty(self, <span class="hljs-string">"buildParams"</span>, {
        ...
        <span class="hljs-keyword">if</span> (self.buildable) {</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>If this Def is already buildable, update self.buildParams and
continue using the old builder function.</p></div></div><div class="code"><div class="wrapper">            <span class="hljs-keyword">return</span> self;
        }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Every buildable type will have its &quot;type&quot; field filled in
automatically. This includes types that are not subtypes of Node,
like SourceLocation, but that seems harmless (TODO?).</p></div></div><div class="code"><div class="wrapper">        self.field(<span class="hljs-string">"type"</span>, <span class="hljs-built_in">String</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{ <span class="hljs-keyword">return</span> self.typeName });</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Override Dp.buildable for this Def instance.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-built_in">Object</span>.defineProperty(self, <span class="hljs-string">"buildable"</span>, {value: <span class="hljs-literal">true</span>});
            ...
            value: <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
                ...
                <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">add</span>(<span class="hljs-params">param, i</span>) </span>{
                    ...
                    <span class="hljs-keyword">if</span> (isNumber.check(i) &amp;&amp; i &lt; argc) {
                        value = args[i];
                    } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (field.defaultFn) {</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Expose the partially-built object to the default
function as its <code>this</code> object.</p></div></div><div class="code"><div class="wrapper">                        value = field.defaultFn.call(built);
                    } <span class="hljs-keyword">else</span> {
                    ...
                    }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>TODO Could attach getters and setters here to enforce
dynamic type safety.</p></div></div><div class="code"><div class="wrapper">                    built[param] = value;
                }
                ...
                });</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Make sure that the &quot;type&quot; field was filled automatically.</p></div></div><div class="code"><div class="wrapper">                <span class="hljs-keyword">if</span> (built.type !== self.typeName) {
                    <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">""</span>);
                }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getBuilderName</span>(<span class="hljs-params">typeName</span>) </span>{
        <span class="hljs-keyword">return</span> typeName.replace(<span class="hljs-regexp">/^[A-Z]+/</span>, <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">upperCasePrefix</span>) </span>{
            ...
            <span class="hljs-keyword">switch</span> (len) {
                <span class="hljs-keyword">case</span> <span class="hljs-number">0</span>: <span class="hljs-keyword">return</span> <span class="hljs-string">""</span>;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>If there&#39;s only one initial capital letter, just lower-case it.</p></div></div><div class="code"><div class="wrapper">                <span class="hljs-keyword">case</span> <span class="hljs-number">1</span>: <span class="hljs-keyword">return</span> upperCasePrefix.toLowerCase();
                <span class="hljs-keyword">default</span>:</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>If there&#39;s more than one initial capital letter, lower-case
all but the last one, so that XMLDefaultDeclaration (for
example) becomes xmlDefaultDeclaration.</p></div></div><div class="code"><div class="wrapper">                    <span class="hljs-keyword">return</span> upperCasePrefix.slice(
    ...
    exports.getStatementBuilderName = getStatementBuilderName;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>The reason fields are specified using .field(...) instead of an object
literal syntax is somewhat subtle: the object literal syntax would
support only one key and one value, but with .field(...) we can pass
any number of arguments to specify the field.</p></div></div><div class="code"><div class="wrapper">    Dp.field = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">name, type, defaultFn, hidden</span>) </span>{
        <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.finalized) {
    ...
    exports.namedTypes = namedTypes;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Like Object.keys, but aware of what fields each AST type should have.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getFieldNames</span>(<span class="hljs-params">object</span>) </span>{
    ...
    exports.getFieldNames = getFieldNames;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Get the value of an object property, taking object.type and default
functions into account.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getFieldValue</span>(<span class="hljs-params">object, fieldName</span>) </span>{
        <span class="hljs-keyword">var</span> d = Def.fromValue(object);
        <span class="hljs-keyword">if</span> (d) {
        ...
        <span class="hljs-keyword">return</span> object &amp;&amp; object[fieldName];
    }
    exports.getFieldValue = getFieldValue;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Iterate over all defined fields of an object, including those missing
or undefined, passing each field name and effective value (as returned
by getFieldValue) to the callback. If the object has no corresponding
Def, the callback will never be called.</p></div></div><div class="code"><div class="wrapper">    exports.eachField = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">object, callback, context</span>) </span>{
    ...
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Similar to eachField, except that iteration stops as soon as the
callback returns a truthy value. Like Array.prototype.some, the final
result is either true or false to indicates whether the callback
returned true for any element or not.</p></div></div><div class="code"><div class="wrapper">    exports.someField = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">object, callback, context</span>) </span>{
    ...
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>This property will be overridden as true by individual Def instances
when they are finalized.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-built_in">Object</span>.defineProperty(Dp, <span class="hljs-string">"finalized"</span>, {value: <span class="hljs-literal">false</span>});

    Dp.finalize = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
        <span class="hljs-keyword">var</span> self = <span class="hljs-keyword">this</span>;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>It&#39;s not an error to finalize a type more than once, but only the
first call to .finalize does anything.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (!self.finalized) {
            ...
            });</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>TODO Warn if fields are overridden with incompatible types.</p></div></div><div class="code"><div class="wrapper">            extend(allFields, self.ownFields);
            ...
            }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Types are exported only once they have been finalized.</p></div></div><div class="code"><div class="wrapper">            <span class="hljs-built_in">Object</span>.defineProperty(namedTypes, self.typeName, {
                enumerable: <span class="hljs-literal">true</span>,
                value: self.type
            });

            <span class="hljs-built_in">Object</span>.defineProperty(self, <span class="hljs-string">"finalized"</span>, {value: <span class="hljs-literal">true</span>});</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>A linearization of the inheritance hierarchy.</p></div></div><div class="code"><div class="wrapper">            populateSupertypeList(self.typeName, self.supertypeList);
    ...
    };</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Adds an additional builder for Expression subtypes
that wraps the built Expression in an ExpressionStatements.</p></div></div><div class="code"><div class="wrapper">    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">wrapExpressionBuilderWithStatement</span>(<span class="hljs-params">typeName</span>) </span>{
        <span class="hljs-keyword">var</span> wrapperName = getStatementBuilderName(typeName);</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>skip if the builder already exists</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (builders[wrapperName]) <span class="hljs-keyword">return</span>;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>the builder function to wrap with builders.ExpressionStatement</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">var</span> wrapped = builders[getBuilderName(typeName)];</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>skip if there is nothing to wrap</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">if</span> (!wrapped) <span class="hljs-keyword">return</span>;
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">populateSupertypeList</span>(<span class="hljs-params">typeName, list</span>) </span>{
        ...
        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> pos = <span class="hljs-number">0</span>; pos &lt; list.length; ++pos) {
            ...
            <span class="hljs-keyword">if</span> (d.finalized !== <span class="hljs-literal">true</span>) {
                <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">""</span>);
            }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>If we saw typeName earlier in the breadth-first traversal,
delete the last-seen occurrence.</p></div></div><div class="code"><div class="wrapper">            <span class="hljs-keyword">if</span> (hasOwn.call(lastSeen, typeName)) {
                <span class="hljs-keyword">delete</span> list[lastSeen[typeName]];
            }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Record the new index of the last-seen occurrence of typeName.</p></div></div><div class="code"><div class="wrapper">            lastSeen[typeName] = pos;</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Enqueue the base names of this type.</p></div></div><div class="code"><div class="wrapper">            list.push.apply(list, d.baseNames);
        }</div></div></div><div class="segment"><div class="comments "><div class="wrapper"><p>Compaction loop to remove array holes.</p></div></div><div class="code"><div class="wrapper">        <span class="hljs-keyword">for</span> (<span class="hljs-keyword">var</span> to = <span class="hljs-number">0</span>, from = to, len = list.length; from &lt; len; ++from) {
            <span class="hljs-keyword">if</span> (hasOwn.call(list, from)) {
                list[to++] = list[from];
            }
        }
    ...
    <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">extend</span>(<span class="hljs-params">into, from</span>) </span>{
        <span class="hljs-built_in">Object</span>.keys(from).forEach(<span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">name</span>) </span>{
            into[name] = from[name];
        });
