...
(function() {
  window.TotemLodestar = {
    _modules: {},
    load: function() {
      var module, results, settings;
      this.version = $('.settings').data('version');
      this.user_settings._init();
      settings = $('.settings').data('settings');
      results = [];
      for (module in this._modules) {
        results.push(this._modules[module].init(module, settings['modules'][module]));
      }
      return results;
    },
    load_module: function(id, module, settings) {
      ...
      module._id = id;
      return this.load_module_plugins(module);
    },
    load_module_plugins: function(module) {
      var plugin, results;
      results = [];
      for (plugin in module._settings) {
        results.push(module[plugin](module._settings[plugin]));
      }
      return results;
    },
    user_settings: {
      _init: function() {
        if (Cookies.get('TotemLodestar')) {
          return;
        }
        return Cookies.set('TotemLodestar', this._defaults);
      },
      _defaults: {
        layout: {
          full_width: true
      ...
      set: function(value) {
        return Cookies.set('TotemLodestar', value);
      },
      get: function(cname) {
        return Cookies.getJSON('TotemLodestar');
      },
      remove: function(cname) {
        return console.log('Needs implementation');
      }
    }
  };
...
(function() {
  window.TotemLodestar._modules['api'] = {
    init: function(id, options) {
      return TotemLodestar.load_module(id, this, options);
    },
    repositories: function(options) {},
    get_cur_repo: function() {
      return /^\/api\/([1-9a-z-]*)/g.exec(window.location.pathname)[1];
    }
  };
...
(function() {
  window.TotemLodestar._modules['layout'] = {
    ...
    full_width: function(options) {
      var compress, expand, layout_divs, pref, set_layout_button_to;
      expand = function() {
        TotemLodestar.user_settings.set({
          layout: {
            full_width: true
          }
        });
      ...
      layout_divs = function() {
        return $('.article, .top-nav_menu');
      };
      set_layout_button_to = function(direction) {
        switch (direction) {
          case 'compress':
      ...
      return $('#layout-style').on('click', function(e) {
        e.preventDefault();
        if (layout_divs().hasClass('full')) {
          compress();
          return set_layout_button_to('expand');
        } else {
          expand();
          return set_layout_button_to('compress');
        }
      });
    }
  };
...
(function() {
  window.TotemLodestar._modules['side_bar'] = {
    ...
    collapse: function(options) {
      var collapsed_icon, expanded_icon;
      expanded_icon = options['expanded_icon'];
      collapsed_icon = options['collapsed_icon'];
      return $('.side-nav_section-header').on('click', function(e) {
        var icon;
        e.preventDefault();
        $(this).parent().toggleClass('collapsed');
        icon = $(this).children()[0];
        if (icon.className === collapsed_icon) {
          return icon.className = expanded_icon;
        } else {
          return icon.className = collapsed_icon;
        }
      });
    }
  };
...
(function() {
  window.TotemLodestar._modules['table_of_contents'] = {
    ...
    smooth_scroll: function(options) {
      var speed;
      speed = options['speed'];
      $('.toc_list').children().on('click', function(e) {
        var $target, target;
        e.preventDefault();
        target = this.hash;
        $target = $(target);
    ...
    highlight: function(options) {
      var activate_toc_header, build_document_positions, check_header_pos, cur_region, regions, set_cur_region, ticking;
      build_document_positions = function() {
        var prev;
      ...
      check_header_pos = (function(_this) {
        return function(pos, cur_region) {
          if (cur_region === null || pos < cur_region.top || pos > cur_region.bottom) {
            set_cur_region(pos, cur_region);
          }
        };
      })(this);
      set_cur_region = (function(_this) {
        return function(pos, cur_region) {
          regions.forEach(function(header) {
      ...
      activate_toc_header = function(cur_region) {
        var header_href;
